      ...
      <div className="w-full max-w-4xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3 min-w-0">
            {lesson.watched && (
              <CheckCircle className="w-5 h-5 text-red-veon flex-shrink-0" />
            )}
        ...
        <div className="mt-4 flex items-center justify-between gap-4">
          ...
          {lesson.watched ? (
            <button
              ...
              className="flex items-center gap-2 bg-red-veon/20 hover:bg-red-veon/30 border border-red-veon/30 hover:border-red-veon/50 text-red-veon text-sm px-5 py-2.5 rounded-lg transition-colors group/btn"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 bg-red-veon hover:bg-red-veon-dark text-white text-sm font-medium px-5 py-2.5 rounded-lg transition-colors"
            >
        ...
        {justMarked && nextLesson && (
          <div className="mt-3 flex items-center justify-between bg-red-veon/20 border border-red-veon/30 text-red-veon text-sm px-4 py-3 rounded-lg">
            <div className="flex items-center gap-2">
              <CheckCircle className="w-4 h-4" /> Aula concluída!
            </div>
            <button
              onClick={() => onNavigate(nextLesson)}
              className="flex items-center gap-2 bg-red-veon hover:bg-red-veon-dark text-white text-xs font-medium px-4 py-1.5 rounded-lg transition-colors"
            >
